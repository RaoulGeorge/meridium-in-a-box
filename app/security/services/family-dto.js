define(function (require) {
    ...
    FamilyDTO.fromDataCollection = function FamilyDTO_fromDataCollection(dataCollection) {
        var i, dtos = [];
        for (i = 0; i < dataCollection.length; i++) {
            dtos[dtos.length] = new FamilyDTO(dataCollection[i]);
        }
        return dtos;
    };
