...
define(function(require) {
    ...
    var ko = require('knockout'),
        ...
        view = require('text!../views/role-group-popover.html');

    require('system/lang/object');
    require('ui/elements/searchbox/view-model');


    function RoleGroupPopoverViewModel(securityService) {
        base.call(this, view);
    ...
    var base = Object.inherit(KnockoutViewModel, RoleGroupPopoverViewModel);

    RoleGroupPopoverViewModel.dependsOn = [SecurityService];

    RoleGroupPopoverViewModel.prototype.activate = function() {
        // Computed observables.
        this.kom.subscribe(this.filteredGroups, filteredGroups_subscribe.bind(null, this));
    };

    RoleGroupPopoverViewModel.prototype.load = function roleGroupPopoverViewModel_load() {
    ...
    RoleGroupPopoverViewModel.prototype.attach = function (region) {
    ...
    RoleGroupPopoverViewModel.prototype.detach = function RoleGroupPopoverViewModel_detach(region) {
        base.prototype.detach.call(this, region);
    };

    RoleGroupPopoverViewModel.prototype.unload = function RoleGroupPopoverViewModel_unload() {
        this.kom.disposeSubscriptions();
        this.kom.disposeComputeds();
        this.kom.disposeObservables();
    };

    RoleGroupPopoverViewModel.prototype.loadGroup = function loadGroup() {
        var dfd = $.Deferred();
        dfd.resolve(this.filteredGroups());
        return dfd.promise();
    };

    RoleGroupPopoverViewModel.prototype.deactivate = function () {
        this.kom.dispose();
    };

   

    RoleGroupPopoverViewModel.prototype.save = function () {
        return this.availableGroups.selectedItems;
    };

    RoleGroupPopoverViewModel.prototype.translate = function (key) {
    ...
    return RoleGroupPopoverViewModel;
});