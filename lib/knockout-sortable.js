(function (factory) {
    ...
    //if both references aren't found yet, get via AMD if available
      ...
      if (koRef !== undefined && sortableRef === undefined) {
        ...
        define(['sortablejs'], function (amdSortableRef) { factory(koRef, amdSortableRef); }); // MERIDIUM CUSTOMIZATION: changed to use the correct require alias.
      }
        ...
        define(['knockout', 'sortablejs'], factory); // MERIDIUM CUSTOMIZATION: changed to use the correct require alias.
      }
    }
